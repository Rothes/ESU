...
include("bukkit:module:bukkit-bom", "bukkit:module:bukkit-kotlin-extensions", "bukkit:module:bukkit-scheduler", "bukkit:module:bukkit-versions")
include("bukkit:version")
include("bukkit:version:remapped-api")
include("bukkit:version:remapped")
include("bukkit:version:v1_17_1")
include("bukkit:version:v1_18")
include("bukkit:version:v1_18_2")
include("bukkit:version:v1_19")
include("bukkit:version:v1_19_3")
include("bukkit:version:v1_20")
include("bukkit:version:v1_20_2")
include("bukkit:version:v1_20_4")
include("bukkit:version:v1_20_6") // dev bundle of 1.20.5 seems broken, use 1.20.6 hotfix
