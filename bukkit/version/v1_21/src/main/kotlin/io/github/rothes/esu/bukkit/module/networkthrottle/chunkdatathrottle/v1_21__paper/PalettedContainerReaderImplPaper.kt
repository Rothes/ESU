...
class PalettedContainerReaderImplPaper: PalettedContainerReader {
    ...
    private val storage = dataType.declaredFields.first { it.type == BitStorage::class.java }.usObjGetter
    private val palette = dataType.declaredFields.first { it.type == Palette::class.java }.usObjGetter
